...
export const reportComponentRegistry: Record<string, React.FC<ReportComponentProps>> = {
  'table':      RptTable,
  'bar-chart':  RptChart,
  'line-chart': RptChart,
  'pie-chart':  RptChart,
...
/** 获取已注册的组件 */
export function getReportComponent(type: string): React.FC<ReportComponentProps> {
...
@media print {
  ...
  // 保留背景色和阴影
  .rpt-chart-container, .rpt-kpi-card {
...
```json
{
  ...
  "data": {
    ...
    "layoutJson": {
      ...
      "components": [
        ...
        },
        {
          ...
          "config": {
            "metrics": [
              { "label": "本月销售额", "field": "total_sales", "format": "currency" },
              { "label": "环比增长", "field": "mom_growth", "format": "percent" },
              { "label": "订单数", "field": "order_count", "format": "number" },
              { "label": "客单价", "field": "avg_order_value", "format": "currency" }
            ]
          }
        },
        {
        ...
        },
        {
          ...
          "config": {
            "columns": [
              { "field": "order_no", "header": "订单号", "width": "15%", "align": "left" },
              { "field": "customer", "header": "客户", "width": "20%", "align": "left" },
              { "field": "amount", "header": "金额", "width": "12%", "align": "right", "format": "currency" },
              { "field": "order_date", "header": "日期", "width": "12%", "align": "center", "format": "date" },
              { "field": "sales_rep", "header": "销售代表", "width": "12%", "align": "left" },
              { "field": "status", "header": "状态", "width": "10%", "align": "center" }
            ],
            "pageSize": 50,
            "showRowNumber": true,
            "showSummaryRow": true,
    ...
    "dataRows": {
      ...
      "detail_data": [
        { "_componentIndex": 3, "order_no": "SO-20260501-001", "customer": "XX科技", "amount": 50000, "order_date": "2026-05-01", "sales_rep": "李四", "status": "已完成" }
      ],
      "dept_distribution": [
    ...
    "components": {
      ...
      "items": {
        ...
        "properties": {
          "type": {
            "type": "string",
            "enum": ["table", "bar-chart", "line-chart", "pie-chart", "kpi-card", "text-block", "page-break", "image"]
          },
          "bindKey": { "type": "string" },
          "config": { "type": "object" }
        }
